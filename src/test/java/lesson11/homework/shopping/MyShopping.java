...
public class MyShopping {
    ...
    public void makeShopping() {
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("#my-account > div.ac_results > ul > li"))).click();
        wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("#add_to_cart > button > span"))).click();
        wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("#layer_cart > div.clearfix > div.layer_cart_cart.col-xs-12.col-md-6 > div.button-container > a > span"))).click();
